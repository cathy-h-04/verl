#!/usr/bin/env python3
"""Convert selected JSONL files under monitoring_small_cleaned to CSV.
...
# Set to True if you want to delete the JSONL after successful CSV write.
# This only applies to merged_sweep_*.jsonl (the only current target).
DELETE_JSONL_AFTER_CONVERT = True
